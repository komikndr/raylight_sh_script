...
wget -O /workspace/ComfyUI/models/diffusion_models/anima-preview3-base.safetensors \
  "https://huggingface.co/circlestone-labs/Anima/resolve/main/split_files/diffusion_models/anima-preview3-base.safetensors?download=true" &

wget -O /workspace/ComfyUI/models/text_encoders/qwen_3_06b_base.safetensors \
