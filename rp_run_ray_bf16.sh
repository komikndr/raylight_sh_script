...
wget -O /workspace/ComfyUI/models/diffusion_models/wanBF16.safetensors \
...
wget -O /workspace/ComfyUI/models/loras/self_lx2v.safetensors\
  "https://huggingface.co/Kijai/WanVideo_comfy/resolve/main/Lightx2v/lightx2v_I2V_14B_480p_cfg_step_distill_rank32_bf16.safetensors?download=true"
