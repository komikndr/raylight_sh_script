...
wget -O /workspace/ComfyUI/models/diffusion_models/flux_2.safetensors \
...
wget -O /workspace/ComfyUI/models/text_encoders/mistral.safetensors \
  "https://huggingface.co/Comfy-Org/flux2-dev/resolve/main/split_files/text_encoders/mistral_3_small_flux2_fp8.safetensors?download=true"

wget -O /workspace/ComfyUI/models/vae/ae_flux2.safetensors \
