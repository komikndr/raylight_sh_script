...
wget -O /workspace/ComfyUI/models/diffusion_models/wan5_fp8_e4m3.safetensors \
  "https://huggingface.co/Kijai/WanVideo_comfy_fp8_scaled/resolve/main/TI2V/Wan2_2-TI2V-5B_fp8_e4m3fn_scaled_KJ.safetensors?download=true" &

wget -O /workspace/ComfyUI/models/diffusion_models/wan5_fp8_e5m2.safetensors \
  "https://huggingface.co/Kijai/WanVideo_comfy_fp8_scaled/resolve/main/TI2V/Wan2_2-TI2V-5B_fp8_e5m2_scaled_KJ.safetensors?download=true" &

wget -O /workspace/ComfyUI/models/text_encoders/umt5xxl.safetensors \
  "https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors?download=true" &

wget -O /workspace/ComfyUI/models/vae/wanvae2_2.safetensors \
